...
Katana [Compute Nodes](glossary.md#compute_nodes) run a 64 bit version of the CentOS distribution of Linux. Currently version 7.8. The [Head Node](glossary.md#head_node) runs RedHat 7.8.
