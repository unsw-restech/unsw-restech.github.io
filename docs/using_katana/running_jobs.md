...
!!! Key Notes The Grace Hopper node contains one 72-core ARM CPU with 480GB memory.
It is a different CPU architecture to the rest of Katana, so different binaries must be used.
